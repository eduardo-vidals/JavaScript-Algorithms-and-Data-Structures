...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function render() {
            ...
            var tweetURL = "https://twitter.com/intent/tweet?hashtags=quotes&text=" + encodeURIComponent('"' + this.state.text + '" - ' + this.state.author);
            var tumblrURL = 'https://www.tumblr.com/widgets/share/tool?posttype=quote&tags=quotes&caption=' + encodeURIComponent(this.state.author) + '&content=' + encodeURIComponent(this.state.text) + '&canonicalUrl=https%3A%2F%2Fwww.tumblr.com%2Fbuttons&shareSource=tumblr_share_button';
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                'a',
                                { href: tweetURL, target: "_blank", id: "tweet-quote",
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'button',
                        { id: "new-quote", className: "color-transition", type: "button", onClick: this.newQuote,
                            style: colorStyle },
                        'New quote'
                    )
                )
