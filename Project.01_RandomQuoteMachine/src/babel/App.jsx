        ...
        return (
            <AutoHeight id="quote-box" element="div">
                ...
                <div className={"buttons"}>
                    <ul>
                        <li>
                            <a href={this.state.tweetQuote} target={"_blank"} id={"tweet-quote"}
                               className={"fab fa-twitter color-transition"} style={colorStyle}> </a>
                        </li>

                        <li>
                            <a href={this.state.tumblrQuote} target={"_blank"}
                ...
                <div className={"buttons new-quote-button"}>
                    <button id={"new-quote"} className={"color-transition"} onClick={this.newQuote}
                            style={colorStyle}>
                        New quote
                    </button>
                </div>
